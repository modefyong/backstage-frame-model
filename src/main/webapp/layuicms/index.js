...
layui.config({//基础目录
    ...
    function init() {
        //显示姓名
    	if(window.sessionStorage.getItem('sysUser')){
   ...
   /* $(".changeSkin").click(function () {
        layer.open({
            ...
            success: function (index, layero) {
                var skin = window.sessionStorage.getItem("skin");
                console.log(window.sessionStorage.getItem("skinValue"));
...
*/
    ...
    function showNotice() {
        layer.open({
            ...
            btn: ['好的'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>德州两山环境咨询有限公司是经德州市工商行政管理部门登记注册、具有独立法人资格的，专业从事环境影响评价、环保验收、环评验收、环境监测、风险评估、危险废物规范化管理、企业事业单位突发环境事件应急预案备案、排污许可证办理及环保设备服务的综合性环境咨询服务公司，致力于为工业企业、工业园区、各级政府机构提供高效性、专业性的一站式环保管家服务。</p></div>',
